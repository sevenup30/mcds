...
const experiences = [
  ...
  {"start": new Date(2017, 11), "end" : new Date(2020,4), "classname": "laposte","name": "La Poste BSCC", "key":"lp_bscc", "bulletpoints": ["Symfony","PhP","Python","JS", "Jenkins", "Gitlab", "Openshift", "Gitlab", "CICD"] },
